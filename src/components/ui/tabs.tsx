...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "text-muted-foreground inline-flex h-12 w-full items-center justify-center rounded-lg p-[3px] gap-1 shadow-md bg-card",
        className
      )}
      {...props}
    />
